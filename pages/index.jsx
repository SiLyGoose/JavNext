			...
			<main className={`d-flex flex-column inner ${styles.main}`}>
				...
				<div className="row w-100 align-items-center mx-auto">
					<div className={`${styles.container} container`}>
						<Image alt="JavKing" src="/images/JavKing_new_FINISHED.png" className="img-fluid" width={500} height={500} />
					</div>
				</div>
				<div className="row w-100 justify-content-center mx-auto">
					<div className="container text-center">
						<h1 className={utilStyles.fontAdjust1}>JavKing</h1>
						<p className={`${utilStyles.fontType5} ${utilStyles.fontAdjust2}`}>A simple Discord musicbot</p>
